  ...
  return (
    <div className="bg-black bg-opacity-50 rounded-lg p-6 text-white">
      ...
      <div className="space-y-2 mb-6">
        ...
        <p><span className="text-blue-300">Next Payment:</span> {policy.nextPayment}</p>
        <p><span className="text-blue-300">Status:</span> {policy.status}</p>
        <p><span className="text-blue-300">Premium Paid:</span> {policy.premiumPaid ? 'Yes' : 'No'}</p>
      </div>
