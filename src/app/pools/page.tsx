...
const page = ()=> {
  // Mock data and state (replace with actual data fetching and state management)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-blue-900 to-blue-700 px-20">
      <main className="container mx-auto px-4 py-24">
        <h1 className="text-4xl font-bold text-white mb-8">Insurance Pools</h1>
...
export default page;
function PoolInfoCard({ title, value }:{title:string,value:string}) {
  return (
